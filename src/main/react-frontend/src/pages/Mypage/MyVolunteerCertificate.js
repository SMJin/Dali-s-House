    ...
    <div className="MyVolunteerCertificate">
      ...
      <div className="MyVolunteerCertificate_wrapper">
        ...
        <div className="CertList_wrapper">
          {certList.map((cert) => (
            <div className="CertList_list_wrapper" key={cert.id}>
              <div className="list_lssuance_text">{cert.lssuance}</div>
              <div className="list_title_text">{cert.title}</div>
              <div className="list_date_text">{cert.date}</div>
            </div>
          ))}
        </div>
      </div>
